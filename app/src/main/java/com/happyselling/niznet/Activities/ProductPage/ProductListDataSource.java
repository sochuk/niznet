...
public class ProductListDataSource extends PageKeyedDataSource<Long, Result> {

    private static final String TAG = ProductListDataSource.class.getSimpleName();
    ...
    public ProductListDataSource(Context mContext, BaseApiService mApiService,String productCode, String productName,
    ...
    public void loadInitial(@NonNull LoadInitialParams<Long> params,
        ...
        mApiService.getProductList(1, params.requestedLoadSize,searchParam)
    ...
    public void loadAfter(@NonNull LoadParams<Long> params,
        ...
        mApiService.getProductList(params.key, params.requestedLoadSize,searchParam).enqueue(new Callback<ProductList>() {
            @Override
            public void onResponse(Call<ProductList> call, Response<ProductList> response) {
                if (response.isSuccessful()) {
